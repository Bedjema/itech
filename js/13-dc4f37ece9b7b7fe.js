    ...
    [13], {
        ...
        3013: function(e, t, r) {
            ...
            var v_logo = function(e) {
                    return eT.createElement("svg", _extends({
                        xmlns: "http://www.w3.org/2000/svg",
                        width: 63,
                        height: 47,
                        fill: "none"
                    }, e), l || (l = eT.createElement("path", {
                        d: "M62.532.722 45.662 42.1a6.294 6.294 0 0 1-5.828 3.917h-17.05a6.293 6.293 0 0 1-5.824-3.912L.039.722A.511.511 0 0 1 .512.017H17.59c.426 0 .807.264.957.662l12.79 34.109L44.022.683c.148-.4.531-.666.957-.666H62.06c.363 0 .61.368.474.703l-.002.002Z",
                        fill: "#fff"
                    })))
                },
                eW = r(2110),
                                        ...
                                        children: (0, eG.jsx)("div", {
                                            ...
                                            children: null === (a = e.links) || void 0 === a ? void 0 : a.map((e, t) => {
                                                ...
                                                return (0, eG.jsxs)(eV.z, {
                                                    href: l,
                                                    className: "group/link from-enterprise-yellowGreen relative bg-gradient-to-r to-[#80FFC9] bg-clip-text align-middle text-neutral-400 last:pb-4 hover:text-transparent lg:leading-[110%] lg:last:pb-7",
                                                    children: [(0, eG.jsx)("p", {
                                                        className: "mr-6",
                                                        children: r
                                                    }), (0, eG.jsx)("div", {
                                    ...
                                    children: [(0, eG.jsxs)("div", {
                                        ...
                                        children: [r && r.length > 1 && (0, eG.jsx)(LanguageSelector, {
                                            ...
                                            children: [(0, eG.jsx)(ez.h, {
                                                ...
                                                className: "border-enterprise-gray hover:text-enterprise-black rounded-full border-[1px] border-solid from-[#6c75fe] to-[#80FFC9] p-2 hover:bg-gradient-to-r",
                                        ...
                                        children: [(0, eG.jsxs)("div", {
                                            ...
                                            children: "\xa9 Copyright ".concat(new Date().getFullYear(), " VEED")
                                        })]
                                    })]
                                }), (0, eG.jsx)("hr", {
            ...
            var video_editor = function(e) {
                return eT.createElement("svg", video_editor_extends({
                    ...
                    filter: "url(#video-editor_svg__a)"
            ...
            let NavItem = e => (0, eG.jsx)("li", {
                ...
                FeaturedButton = e => (0, eG.jsxs)(eV.z, {
                    ...
                    children: [(0, eG.jsx)("div", {
                        className: "to-enterprise-blue absolute inset-0 bg-gradient-to-br from-[#9B7AFA] opacity-0 transition-opacity group-hover:opacity-100"
                    }), (0, eG.jsxs)("div", {
